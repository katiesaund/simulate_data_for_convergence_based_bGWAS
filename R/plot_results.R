...
df %>% 
  ...
  ggplot() +
  geom_bar(aes(x = epsilon_category, y = percent_signficant, fill = epsilon_category), stat = "identity", position = "dodge") + 
...
ggsave("../figures/pval_vs_epsilon_dot_plot_bin_and_cont.pdf", height = 6, width = 12, units = "in")
...
df %>% 
  ...
  ggsave("../figures/pval_histogram_just_continuous_BM.pdf", height = 6, width = 12, units = "in")
