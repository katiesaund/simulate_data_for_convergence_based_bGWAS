...
binary_AR_df_list <- add_WN(binary_AR_df_list, tree_list) 
# Due to WN stuff the ancestral reconstructions are now wrong!^

binary_AR_and_conf_mat <- ancestral_reconstruction(binary_AR_df_list,
                                                   tree_list,
                                                   "discrete")
# So fix the ancestral reconstructions here^
...
BM_phenotype_names_list <- 
  select_BM_traits(binary_AR_df_list, phylo_signal_list, num_phenos)
WN_phenotype_names_list <- 
  select_WN_traits(binary_AR_df_list, phylo_signal_list, num_phenos)
...
BM_pheno_sync_trans_by_edge_list <- 
  find_transition_edges(tree_list, BM_phenotype_AR_mat_list, "discrete")
...
WN_pheno_sync_trans_by_edge_list <- 
  find_transition_edges(tree_list, WN_phenotype_AR_mat_list, "discrete")
...
genotype_phyc_trans_by_edge_list <- 
  convert_to_phyc_trans(genotype_AR_mat_list, genotype_sync_trans_by_edge_list)
